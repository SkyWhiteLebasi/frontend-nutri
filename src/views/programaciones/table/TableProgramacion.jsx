...
import { ProgramacionColumns } from './DataProgramacion';
...
function TableProgramacion({ searchTerm, setSearchTerm }) {
  ...
  const hasUpdatePermission = sessionStorage.getItem("auth_permisos")?.includes("programaciones.update");
  const hasDestroyPermission = sessionStorage.getItem("auth_permisos")?.includes("programaciones.destroy");
        ...
        return (
          <Stack direction="row" spacing={2}>
            ...
            {hasDestroyPermission && (
              <Button variant="outlined" onClick={() => deleteProgramacion(params.id)} startIcon={<DeleteIcon />} color="warning">
                Eliminar
              </Button>
            )}
          </Stack>
    ...
    <ThemeProvider theme={theme}>
      <div className={classes.tableContainer}>
        ...
        >
          {/* <DataGrid
            rows={programaciones}
            columns={ProgramacionColumns.concat(actionColumn)}
            pageSize={10}
            components={{
              Toolbar: GridToolbar,
            }}
...
TableProgramacion.propTypes = {
  searchTerm: PropTypes.string.isRequired,
  setSearchTerm: PropTypes.func.isRequired,
};
export default TableProgramacion;

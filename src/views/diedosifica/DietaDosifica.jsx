        ...
        <DashboardLayout>
            ...
            <ArgonBox py={3}>
                <ArgonBox mb={3}>
                    <Card className="" id="">
                        <CardHeader
                            title="Lista de Dietas Dosificaciones"
                            subheader="Aquí se tiene las Dietas Dosificaciones definidas"
                            action={
                                <div>
                                    ...
                                    <Button variant="outlined" startIcon={<AddBoxIcon style={{ color: '#49bfd9', size: "large" }} />} size="large" style={{ fontSize: '16px', color: '#49bfd9' }}>
                                        <Link to={'/dosificadietas/form'} style={{ color: '#49bfd9' }}>
                                            Crear
                                        </Link>
                                    </Button>
                                     ) : null}

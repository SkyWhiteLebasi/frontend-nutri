...
import { ProductoReporteColumns } from './DataProductoReporte';


import { Api_URL } from "config/Api_URL";
const URI = Api_URL + "reportesproducto/"
...
function TableProductoReporte({ searchTerm, setSearchTerm }) {
          ...
          <DataGrid
           {...memoizedReporte}
            rows={productoReporte.filter((row) => {
              ...
              return (
                row.nombre_producto.toLowerCase().includes(searchTerm.toLowerCase()) ||
                row.cod_producto.toLowerCase().includes(searchTerm.toLowerCase())
              );
            })}
            columns={ProductoReporteColumns}
            pageSize={10}
...
TableProductoReporte.propTypes = {
  searchTerm: PropTypes.string.isRequired,
  setSearchTerm: PropTypes.func.isRequired,
};
export default TableProductoReporte;
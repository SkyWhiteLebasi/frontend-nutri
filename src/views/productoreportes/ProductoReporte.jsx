...
import TableProductoReporte from "./table/TableProductoReporte";
                        ...
                        <CardHeader
                            ...
                            action={
                                <div>
                                    ...
                                    >
                                        <Link to={'/productoreportes/salidareporte'} style={{ color: 'green' }}>
                                            salidas de hoy
                                        </Link>
                                    </Button>

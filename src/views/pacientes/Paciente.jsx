...
import TablePaciente from "./table/TablePaciente";

function Paciente() {
    const [searchTerm, setSearchTerm] = useState(''); // Define el estado y la función
                ...
                <ArgonBox mb={3}>
                    <Card className="" id="">
                        <CardHeader
                            ...
                            subheader="Aquí se encuentra la lista de pacientes registrados"
                            action={
                                <div>
                                    {sessionStorage.getItem("auth_permisos")?.includes("pacientes.store") ? (
                                        ...
                                        <Button variant="outlined" startIcon={<AddBoxIcon style={{ color: '#49bfd9', size: "large" }} />} size="large" style={{ fontSize: '16px', color: '#49bfd9' }}>
                                            <Link to={'/pacientes/form'} style={{ color: '#49bfd9' }}>
                                                Crear
                                            </Link>
                                        </Button>
                                    ) : null}
                                    {sessionStorage.getItem("auth_permisos")?.includes("pacientes.store") ? (
                                        ...
                                        >
                                            <Link to={'/pacientes/form-excel'} style={{ color: 'green' }}>
                                                Importar Excel
                                            </Link>
                                        </Button>
                                    ) : null}
                        ...
                        <CardContent>
                            ...
                            <TablePaciente searchTerm={searchTerm} setSearchTerm={setSearchTerm} />
                        </CardContent>
                    </Card>
                </ArgonBox>
            </ArgonBox>

...
import TablePedidoNormal from "./table/TablePedidoNormal";

function PedidoNormal() {
        ...
        <DashboardLayout>
            ...
            <ArgonBox py={3}>
                <ArgonBox mb={3}>
                    <Card className="" id="">
                        <CardHeader
                            title="Lista de Pedidos Normales"
                            subheader="Aquí se encuentra los pedidos de regimen normal"
                            action={
                                <div>
                                    {sessionStorage.getItem("auth_permisos")?.includes("pedidosnormales.store") ? (
                                        ...
                                        <Button variant="outlined" startIcon={<AddBoxIcon style={{ color: '#49bfd9', size: "large" }} />} size="large" style={{ fontSize: '16px', color: '#49bfd9' }}>
                                            <Link to={'/pedidonormales/form'} style={{ color: '#49bfd9' }}>
                                                Crear
                                            </Link>
                                        </Button>
                        ...
                        <CardContent>
                            ...
                            <TablePedidoNormal searchTerm={searchTerm} setSearchTerm={setSearchTerm} />
                        </CardContent>
                    </Card>
                </ArgonBox>
            </ArgonBox>

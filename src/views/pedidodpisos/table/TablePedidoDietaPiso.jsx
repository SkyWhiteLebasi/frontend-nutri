...
import { PedidodPisosColumns } from './DataPedidoDietaPiso';
...
function TablePedidoDietaPiso({ searchTerm, setSearchTerm }) {
  ...
  const hasUpdatePermission = sessionStorage.getItem("auth_permisos")?.includes("pedidodpisos.update");
  const hasDestroyPermission = sessionStorage.getItem("auth_permisos")?.includes("pedidodpisos.destroy");
...
TablePedidoDietaPiso.propTypes = {
  searchTerm: PropTypes.string.isRequired,
  setSearchTerm: PropTypes.func.isRequired,
};
export default TablePedidoDietaPiso;
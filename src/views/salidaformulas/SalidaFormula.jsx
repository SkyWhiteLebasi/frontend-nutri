...
import TableSalidaFormula from "./table/TableSalidaFormula"

function SalidaFormula() {
        ...
        <DashboardLayout>
            ...
            <ArgonBox py={3}>
                <ArgonBox mb={3}>
                    <Card className="" id="">
                        <CardHeader
                            title="Lista de Salida Formula"
                            subheader="Aquí se encuentra el registro de Salida Formula"
                            action={
                                <div>
                                    {sessionStorage.getItem("auth_permisos")?.includes("salida_formulas.store") ? (
                                        ...
                                        <Button variant="outlined" startIcon={<AddBoxIcon style={{ color: '#49bfd9', size: "large" }} />} size="large" style={{ fontSize: '16px' }} color="primary">
                                            <Link to={'/salidaformulas/form'} style={{ color: '#49bfd9' }}>
                                                Crear
                                            </Link>
                                        </Button>
                                    ) : null}
                        ...
                        <CardContent>
                            ...
                            <TableSalidaFormula searchTerm={searchTerm} setSearchTerm={setSearchTerm} />
                        </CardContent>
                    </Card>
                </ArgonBox>
            </ArgonBox>

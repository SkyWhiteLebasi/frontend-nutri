...
const Form = () => {
  ...
  const getSalidas = async () => {
    try {
      ...
      setobservacionSalida(response.data.observacion_salida);
  ...
  return (
    <Card>
      <ArgonBox p={1} mb={1} textAlign="center">
        <CardHeader
          title={id ? "ACTUALIZAR SALIDA DE FORMULA" : "REGISTRAR NUEVA SALIDA DE FORMULA"}
        />
      </ArgonBox>
        ...
        <ArgonBox component="form" role="form" onSubmit={handleSubmit_1}>
              ...
              {/* <Grid item xs={4}>
                <Item>
                  ...
                  <ArgonInput
                    type="text"
                    value={numEntrada}
                    onChange={(event) => setNumEntrada(event.target.value)}
                  />
                </Item>
              </Grid> */}
              <Grid item xs={6}>
                <Item>
                  ...
                  <ArgonInput
                    ...
                    onChange={(event) => {
                      ...
                      setErrorList({ ...errorList, fecha_salida: "" });
                    }}
                  />
                </Item>
              ...
              <Grid item xs={12}>
                <Item>
                  ...
                  <ArgonInput
                    ...
                    onChange={(event) => {
                      setobservacionSalida(event.target.value);
                      setErrorList({ ...errorList, observacion_salida: "" });

                    }}
                  />
                </Item>
                {errorList.observacion_salida && (
                  <span style={{ color: "red", fontSize: "14px", marginTop: "5px" }}>
                    {errorList.observacion_salida}
                  </span>
                )}
          ...
          <ArgonBox display="flex" justifyContent="center" mt={4} mb={2}>
            ...
            <CustomButton
              ...
              fullWidth
            >
              <Link to={"/salidaformulas"} style={{ color: "white" }}>
                Cancelar
              </Link>
            </CustomButton>
          </ArgonBox>

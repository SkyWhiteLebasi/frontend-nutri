...
const URI = Api_URL + "pedidodpisosproduccion/"
        ...
        <Card>
            <ArgonBox p={1} mb={1} textAlign="center">
                ...
                <CardHeader
                    ...
                    title={id ? 'ACTUALIZAR PEDIDO DIETA POR PISOS N. P.' : 'REGISTRAR PEDIDO DIETA POR PISOS'}
                />
            </ArgonBox>
                                                            ...
                                                            <TableRow key={index}>
                                                                ...
                                                                <TableCell
                                                                    sx={{
                                                                        ...
                                                                        //color: 'white',
                                                                        textAlign: 'center'
                                                                    }}>{preparacion.nombre_preparacion}</TableCell>
                                                                <TableCell
                                                                    sx={{
                                                                        fontWeight: "bold",
                                                                        border: "1px solid white",
                                                                ...
                                                                >
                                                                    <TextField
                                                                        ...
                                                                        onChange={(e) =>
                                                                            handlePreparacionChange(index, "cantidad_pedido_normal", e.target.value)
                                                                        }
                                                                    />
                                                                ...
                                                                >
                                                                    <TextField
                                                                        ...
                                                                        onChange={(e) =>
                                                                            handlePreparacionChange(index, "cantidad_pedido_modificado", e.target.value)
                                                                        }
                                                                    />
                            ...
                            <Grid item xs={12}>
                                <Item>
                                    ...
                                    <Autocomplete
                                        ...
                                        getOptionLabel={(option) => 'PISO/AREA:' + ' ' + option.nombre_piso + '            -            ' + ' HOSPITAL:' + '  ' + option.hospital?.desc_red}

                                        renderInput={(params) => <TextField  {...params} />}

                                        renderOption={(props, option, state) => [props, 'PISO/AREA:' + ' ' + option.nombre_piso + '               -             ' + ' HOSPITAL:' + '  ' + option.hospital?.desc_red, state.index]}
                                        // renderOption={(props, option, state) => [props,  , option.id + " " + option.nombre_ambiente]}
                                        renderGroup={(params) => params}
                                        disabled={id ? true : false}
                                    />
                                ...
                                <Item>
                                    ...
                                    <FormControl variant="standard" sx={{ m: 1, minWidth: 420 }}>
                                        ...
                                        >
                                            ...
                                            {/* Agrega más opciones de estado aquí si es necesario */}
                                        </Select>
                                    </FormControl>
                                </Item>
                            </Grid>

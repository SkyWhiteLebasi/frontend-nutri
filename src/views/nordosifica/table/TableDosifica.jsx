...
function TableDosifica({ searchTerm, setSearchTerm }) {
  ...
  const hasUpdatePermission = sessionStorage.getItem("auth_permisos")?.includes("dosificanormales.update");
  const hasDestroyPermission = sessionStorage.getItem("auth_permisos")?.includes("dosificanormales.destroy");

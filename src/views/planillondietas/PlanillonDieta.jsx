...
import TablePlanillonDieta from "./table/TablePlanillonDieta";


function PlanillonDieta() {
    ...
    return (
        <DashboardLayout>
            ...
            <ArgonBox py={3}>
                <Card>
                    <CardHeader
                        title="Lista de planillones de dietas"
                            ...
                            <div>
                                {sessionStorage.getItem("auth_permisos")?.includes("planillondietas.store") ? (
                                    ...
                                    <Button variant="outlined" startIcon={<AddBoxIcon style={{ color: '#49bfd9', size: "large" }} />} size="large" style={{ fontSize: '16px' }} color="primary">
                                        <Link to={'/planillondietas/form'} style={{ color: '#49bfd9' }}>
                                            Crear
                                        </Link>
                                    </Button>
                                ) : null}
                    ...
                    <CardContent>
                        ...
                        <TablePlanillonDieta searchTerm={searchTerm} setSearchTerm={setSearchTerm} />
                    </CardContent>
                </Card>
